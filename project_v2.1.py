...
def fatigue_detect(image, eye_count, mouth_count, eye_state, mouth_state):
    eye_state = eye_state
    ...
    return eye_state, mouth_state, eye_count, mouth_count
...
while True:
    ...
    if last_second != time.localtime(time.time()).tm_sec:
        last_second = time.localtime(time.time()).tm_sec
        eye_state, mouth_state, eye_count, mouth_count = fatigue_detect(image, eye_count, mouth_count, eye_state,
                                                                        mouth_state)
